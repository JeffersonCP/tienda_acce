        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="<?php echo $data['productos']['imagen'] ;?>" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><?php echo $data['productos']['nombre'] ;?>"</h1>
                            <p class="h3 py-2"><?php echo MONEDA.' '. $data['productos']['precio'] ;?>"</p>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?php echo $data['productos']['categoria'] ;?>"</strong></p>
                                </li>
                            </ul>

                            <h6>Descripción:</h6>
                            <p><?php echo $data['productos']['descripcion'] ;?>"</p>

                            <form action="" method="GET">
                                <input type="hidden" id="idProducto" value="<?php echo $data['productos']['id'] ;?>">
                                <div class="row">
                                    <div class="col-auto">
